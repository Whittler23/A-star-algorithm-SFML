...
////////////////////////////////////////////////////////////
/// \brief Define the mStates used for drawing to a RenderTarget
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// Constructing a default set of render mStates is equivalent
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct a default set of render mStates with a custom blend mode
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct a default set of render mStates with a custom transform
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct a default set of render mStates with a custom texture
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct a default set of render mStates with a custom shader
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct a set of render mStates with all its attributes
    ///
    /// \param theBlendMode Blend mode to use
    /// \param theTransform Transform to use
    /// \param theTexture   Texture to use
    ...
    // Static member data
    ////////////////////////////////////////////////////////////
    static const RenderStates Default; ///< Special instance holding the default render mStates
...
/// \ingroup graphics
///
/// There are four global mStates that can be applied to
/// the drawn objects:
...
/// these mStates when they are drawn. For example, a sprite
...
/// directly without defining render mStates explicitly -- the
/// default set of mStates is ok in most cases.
/// \code
/// window.draw(sprite);
/// \endcode
///
...
/// either pass the render mStates unmodified, or change
/// some of them.
