...
public:
    ...
    /// \param mStates   Render mStates to use for drawing
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Save the current OpenGL render mStates and matrices
    ///
    /// This function can be used when you mix SFML drawing
    /// and direct OpenGL rendering. Combined with popGLStates,
    /// it ensures that:
    /// \li SFML's internal mStates are not messed up by your OpenGL code
    /// \li your OpenGL mStates are not modified by a call to a SFML function
    ///
    ...
    /// possible OpenGL mStates and matrices, even the ones you
    /// don't care about. Therefore it should be used wisely.
    /// It is provided for convenience, but the best results will
    /// be achieved if you handle OpenGL mStates yourself (because
    /// you know which mStates have really changed, and need to be
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Restore the previously saved OpenGL render mStates and matrices
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Reset the internal OpenGL mStates so that the target is ready for drawing
    ///
    /// This function can be used when you mix SFML drawing
    /// and direct OpenGL rendering, if you choose not to use
    /// pushGLStates/popGLStates. It makes sure that all OpenGL
    /// mStates needed by SFML are set, so that subsequent draw()
...
private:
    ...
    ///
    /// \param mStates Render mStates used for drawing
    ///
    ////////////////////////////////////////////////////////////
    void cleanupDraw(const RenderStates& states);

    ////////////////////////////////////////////////////////////
    /// \brief Render mStates cache
    ///
    ////////////////////////////////////////////////////////////
    struct StatesCache
    {
        ...
        bool      glStatesSet;    ///< Are our internal GL mStates set yet?
    ...
    StatesCache m_cache;       ///< Render mStates cache
...
/// OpenGL mStates are not messed up by calling the
